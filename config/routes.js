...
apiRouter.put("/api/v1/products/offer/accept/:id/:buyer_id", controllers.api.v1.transactionController.acceptedOffer);
apiRouter.put("/api/v1/products/offer/accept/:id/:buyer_id", controllers.api.v1.transactionController.rejectedOffer)
